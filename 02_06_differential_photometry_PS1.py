            ...
            if DOIT :   
                ...
                try : 
                    ...
                    if SOLVE :
                        ...
                        if verbose == True :
                            print(f"{DIFFPRESULTDIR}/{fpath.stem}_DAOStarfinder_fwhm_{FWHM}.png is created...")
                        ...
                        if verbose == True :
                            print("len(df_apphot_sub): ", len(df_apphot_sub))
                            print("df_apphot_sub:\n", df_apphot_sub)
