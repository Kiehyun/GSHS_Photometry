...
file_age = 60
file_retry_dt = datetime(2025, 3, 3, 19, 10)
...
# TODODIR = PROJECDIR / "-_-_-_2025-03_-_GSON300_STF-8300M_-_1bin"  # -2
# TODODIR = PROJECDIR / "-_-_-_2025-03_-_RiLA600_ASI6200MMPro_-_3bin"  # -3
    ...
    if DOIT :   
        ...
        try : 
            ...
            if SOLVE :
                ...
                # try:
                #     _astro_utilities.plot_ps1_magnitude(hdul, wcs, df_phot_PS1, 
    ...
    if summary is not None : 
        ...
        for batch in range(num_batches):
            ...
            for fullname in fullnames[batch*num_batches:(batch+1)*num_batches]:
                ...
                myMP.run(p, fullname, DIFFPRESULTDIR, df_targ, tryagain=tryagain, file_retry_dt=file_retry_dt)
